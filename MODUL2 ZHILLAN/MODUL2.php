...
// silakan taruh code kalian di bawah
if ($tinggi_badan == null || $berat_badan == null || $berat_badan == 0 || $tinggi_badan == 0) {
    $pesan_error = "Tinggi badan atau Berat badan tidak boleh kosong";
} else {
    $pemberitahuan = $tinggi_badan / 100;
    $bmi = $berat_badan / ($pemberitahuan*$pemberitahuan);
